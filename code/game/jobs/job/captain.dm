...
/datum/job/captain
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.ckey == "ssting")
			//H.equip_to_slot_or_del(new /obj/item/clothing/gloves/the_lord_of_the_rings(H), slot_gloves) FAT, VERY FAT, FAT32, DEAR \\FRODO\\ DERVEN
			H.equip_to_slot_or_del(new /obj/item/device/flashlight/gem(H), slot_l_hand)
